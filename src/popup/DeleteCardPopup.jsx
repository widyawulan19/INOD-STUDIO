        ...
        <div className='delete-popup-overlay'>
            <div className='delete-popup-content'>
                <div className='delete-title'>
                    <h5> <IoWarningOutline size={15} style={{color:'red', marginRight:'5px'}}/>Confirm Delete Board</h5>
                ...
                <div className="text-delete">
                    ...
                    <p>Apakah anda yakin ingin <span style={{color:'red'}}>menghapus</span>  board ini?</p>
                </div>
